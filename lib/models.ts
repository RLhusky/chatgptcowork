...
export const MODELS: ModelDef[] = [
  {
    ...
    label: "GPT-5.4",
    family: "flagship",
    description: "Current flagship. Fastest and most capable general model.",
  ...
  },
  {
    ...
    label: "GPT-5.4 Codex",
    family: "flagship",
    description: "Coding-tuned 5.4. Best for editors and agents.",
    supportsReasoning: false,
    supportsTools: true,
  },
  {
    ...
    label: "GPT-5.3",
    family: "flagship",
    description: "Previous flagship. Solid balanced fallback.",
    supportsReasoning: false,
    supportsTools: true,
  },
  {
    ...
    label: "GPT-5.2",
    family: "flagship",
    description: "Older flagship. Fast and inexpensive.",
    supportsReasoning: false,
    supportsTools: true,
  },
  {
    ...
    label: "GPT-5.2 Codex",
    family: "flagship",
    description: "Older coding-tuned variant.",
    supportsReasoning: false,
    supportsTools: true,
  },
  {
